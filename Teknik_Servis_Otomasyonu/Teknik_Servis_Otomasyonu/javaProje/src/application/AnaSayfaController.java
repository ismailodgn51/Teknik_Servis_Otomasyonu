...
public class AnaSayfaController {
    ...
    // private Object root;
      ...
      void personelSaglikbilgi_button(ActionEvent event) {
		...
		FormManager FormOpn =new FormManager();
		  FormOpn.FormOpen("HastaTeshis.fxml","Hasta Saðlýk Bilgi","teslim.png");
      }
      @FXML
      void btn_geri1(ActionEvent event) {
    	  Node  source = (Node)  event.getSource();
		    ...
		    stage.close();
		FormManager FormOpn =new FormManager();
		  FormOpn.FormOpen("giris.fxml","Giriþ","teslim.png");
      }
      ...
      void MusteriFinans_button(ActionEvent event) {
    	  ...
    	  FormManager FormOpn =new FormManager();
    	  FormOpn.FormOpen("Finans.fxml","Müþteri Finans","finans2.png");
    	  Node  source = (Node)  event.getSource();
    	    Stage stage = (Stage)source.getScene().getWindow();
    	    stage.close(); 
      ...
      void SikayetVeTalepler_button(ActionEvent event) {
    	  ...
    	  FormManager FormOpn =new FormManager();
    	  FormOpn.FormOpen("MusteriSikayetTalepGor.fxml","Þikayet Ve Taleplerleri Görüntüle","þikayettalep.png");
    	  Node  source = (Node)  event.getSource();
    	    Stage stage = (Stage)source.getScene().getWindow();
    	    stage.close();
      ...
      void sifre_kullanici_button(ActionEvent event) {
    	  FormManager FormOpn =new FormManager();
    	  FormOpn.FormOpen("YoneticiIslemleri.fxml","Kullanýcý Ve Þifre Ýþlemleri","PngItem_1280822.png");
    	  Node  source = (Node)  event.getSource();
    	    Stage stage = (Stage)source.getScene().getWindow();
    	    stage.close();
      }
    ...
    void personelGuncelle_button(ActionEvent event) {
    	FormManager FormOpn =new FormManager();
    	FormOpn.FormOpen("YeniPersonelGüncelle.fxml","Personel Güncelleme Ýþlemleri","güncelle.jpg");
    	Node  source = (Node)  event.getSource();
  	    Stage stage = (Stage)source.getScene().getWindow();
  	    stage.close();
    }
    ...
    void personelKaydet_button(ActionEvent event) {
    	FormManager FormOpn =new FormManager();
    	FormOpn.FormOpen("YeniPersonelKaydet.fxml","Yeni Personel Ekleme Ýþlemleri","kaydet.png");
    	Node  source = (Node)  event.getSource();
  	    Stage stage = (Stage)source.getScene().getWindow();
  	    stage.close();
    }
    ...
    void personelSil_button(ActionEvent event) {
    	FormManager FormOpn =new FormManager();
    	FormOpn.FormOpen("YeniPersonelSil.fxml","Personel Silme Ýþlemleri","sil.png");
    	Node  source = (Node)  event.getSource();
  	    Stage stage = (Stage)source.getScene().getWindow();
  	    stage.close();
    }
