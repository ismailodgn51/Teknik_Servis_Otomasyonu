...
public class MusteriSikayetTalepController {
	public  MusteriSikayetTalepController() {
    ...
    public void DegerleriGetir(TableView tablo) {
    	...
    	try {
    	 ...
    	 KayitlarListe.add(new musteriBilgi(getirilen.getInt("M_id"),getirilen.getString("M_ad"),getirilen.getString("M_soy"),getirilen.getString("M_mail"), getirilen.getString("M_tel"), sql, sql, sql, sql, sql, 0, sql, sql, sql, sql,sql,sql));
    	    }
